export const LOCAL_API_URL = 'http://localhost:3400/v1';
export const PRODUCTION_API_URL = 'https://api.amzascension.com/v1/';
...
export const Country_AND_STATES = [
  ...
  {
    country: 'Algeria',
    state: ['Adrar', 'Ain Defla', 'Ain Temouchent', 'Alger', 'Annaba', 'Batna', 'Bechar', 'Bejaia', 'Biskra', 'Blida', 'Bordj Bou Arreridj', 'Bouira', 'Boumerdes', 'Chlef', 'Constantine', 'Djelfa', 'El Bayadh', 'El Oued', 'El Tarf', 'Ghardaia', 'Guelma', 'Illizi', 'Jijel', 'Khenchela', 'Laghouat', 'Muaskar', 'Medea', 'Mila', 'Mostaganem', 'M_Sila', 'Naama', 'Oran', 'Ouargla', 'Oum el Bouaghi', 'Relizane', 'Saida', 'Setif', 'Sidi Bel Abbes', 'Skikda', 'Souk Ahras', 'Tamanghasset', 'Tebessa', 'Tiaret', 'Tindouf', 'Tipaza', 'Tissemsilt', 'Tizi Ouzou', 'Tlemcen']
  },
  {
    country: 'Andorra',
  ...
  {
    country: 'Armenia',
    state: ['Aragatsotn', 'Ararat', 'Armavir', 'Geghark_unik', 'Kotayk', 'Lorri', 'Shirak', 'Syunik', 'Tavush', 'Vayots', 'Dzor', 'Yerevan']
  },
  {
    country: 'Australia',
    state: ['New South Wales', 'Queensland', 'Northern Territory', 'Western Australia', 'South Australia', 'Victoria', 'the Australian Capital Territory', 'and Tasmania']
  },
  {
    country: 'Austria',
  ...
  {
    country: 'Bahamas',
    state: ['Acklins and Crooked Islands', 'Bimini', 'Cat Island', 'Exuma', 'Freeport', 'Fresh Creek', 'Governors_Harbour', 'Green Turtle Cay', 'Harbour Island', 'High Rock', 'Inagua', 'Kemps Bay', 'Long Island', 'Marsh Harbour', 'Mayaguana', 'New Providence', 'Nichollstown and Berry Islands', 'Ragged Island', 'Rock Sound', 'Sandy Point', 'San Salvador and Rum Cay']
  },
  {
    country: 'Bahrain',
    state: ['Al Hadd', 'Al Manamah', 'Al Mintaqah al Gharbiyah', 'Al Mintaqah al Wusta', 'Al Mintaqah ash Shamaliyah', 'Al Muharraq', 'Ar Rifa wa al Mintaqah al Janubiyah', 'Jidd Hafs', 'Madinat Hamad', 'Madinat_Isa', 'Juzur Hawar', 'Sitrah']
  },
  {
    country: 'Bangladesh',
  ...
  {
    country: 'Bermuda',
    state: ['Devonshire', 'Hamilton', 'Hamilton', 'Paget', 'Pembroke', 'Saint George', 'Saint Georges', 'Sandys', 'Smiths', 'Southampton', 'Warwick']
  },
  {
    country: 'Bhutan',
  ...
  {
    country: 'Chile',
    state: ['Aysen', 'Antofagasta', 'Araucania', 'Atacama', 'Bio-Bio', 'Coquimbo', 'OHiggins', 'Los Lagos', 'Magallanes y la Antartica Chilena', 'Maule', 'Santiago Region Metropolitana', 'Tarapaca', 'Valparaiso']
  },
  {
    country: 'China',
  ...
  {
    country: 'Egypt',
    state: ['Ad Daqahliyah', 'Al Bahr al Ahmar', 'Al Buhayrah', 'Al Fayyum', 'Al Gharbiyah', 'Al Iskandariyah', 'Al Ismailiyah', 'Al Jizah', 'Al Minufiyah', 'Al Minya', 'Al Qahirah', 'Al Qalyubiyah', 'Al Wadi al Jadid', 'Ash Sharqiyah', 'As Suways', 'Aswan', 'Asyut', 'Bani Suwayf', 'Bur Said', 'Dumyat', 'Janub Sina', 'Kafr ash Shaykh', 'Matruh', 'Qina', 'Shamal Sina', 'Suhaj']
  },
  {
    country: 'El Salvador',
  ...
  {
    country: 'Eritrea',
    state: ['Anseba', 'Debub', 'Debubawi Keyih Bahri', 'Gash Barka', 'Maakel', 'Semenawi Keyih Bahri']
  },
  {
    country: 'Estonia',
  ...
  {
    country: 'France',
    state: ['Alsace', 'Aquitaine', 'Auvergne', 'Basse-Normandie', 'Bourgogne', 'Bretagne', 'Centre', 'Champagne-Ardenne', 'Corse', 'Franche-Comte', 'Haute-Normandie', 'Ile-de-France', 'Languedoc-Roussillon', 'Limousin', 'Lorraine', 'Midi-Pyrenees', 'Nord-Pas-de-Calais', 'Pays de la Loire', 'Picardie', 'Poitou-Charentes', 'Provence-Alpes-Cote dAzur', 'Rhone-Alpes']
  },
  {
    country: 'Gabon',
  ...
  {
    country: 'Hungary',
    state: ['Bacs-Kiskun', 'Baranya', 'Bekes', 'Borsod-Abauj-Zemplen', 'Csongrad', 'Fejer', 'Gyor-Moson-Sopron', 'Hajdu-Bihar', 'Heves', 'Jasz-Nagykun-Szolnok', 'Komarom-Esztergom', 'Nograd', 'Pest', 'Somogy', 'Szabolcs-Szatmar-Bereg', 'Tolna', 'Vas', 'Veszprem', 'Zala', 'Bekescsaba', 'Debrecen', 'Dunaujvaros', 'Eger', 'Gyor', 'Hodmezovasarhely', 'Kaposvar', 'Kecskemet', 'Miskolc', 'Nagykanizsa', 'Nyiregyhaza', 'Pecs', 'Sopron', 'Szeged', 'Szekesfehervar', 'Szolnok', 'Szombathely', 'Tatabanya', 'Veszprem', 'Zalaegerszeg']
  },
  {
    country: 'Iceland',
  ...
  {
    country: 'Iraq',
    state: ['Al Anbar', 'Al Basrah', 'Al Muthanna', 'Al Qadisiyah', 'An Najaf', 'Arbil', 'As Sulaymaniyah', 'At Tamim', 'Babil', 'Baghdad', 'Dahuk', 'Dhi Qar', 'Diyala', 'Karbala', 'Maysan', 'Ninawa', 'Salah ad Din', 'Wasit']
  },
  {
    country: 'Ireland',
  ...
  {
    country: 'Italy',
    state: ['Abruzzo', 'Basilicata', 'Calabria', 'Campania', 'Emilia-Romagna', 'Friuli-Venezia Giulia', 'Lazio', 'Liguria', 'Lombardia', 'Marche', 'Molise', 'Piemonte', 'Puglia', 'Sardegna', 'Sicilia', 'Toscana', 'Trentino-Alto Adige', 'Umbria', 'Valle dAosta', 'Veneto']
  },
  {
    country: 'Jamaica',
  ...
  {
    country: 'Jordan',
    state: ['Ajlun', 'Al Aqabah', 'Al Balqa', 'Al Karak', 'Al Mafraq', 'Amman', 'At Tafilah', 'Az Zarqa', 'Irbid', 'Jarash', 'Maan', 'Madaba']
  },
  {
    country: 'Kazakhstan',
  ...
  {
    country: 'Korea North',
    state: ['Chagang', 'North Hamgyong', 'South Hamgyong', 'North Hwanghae', 'South Hwanghae', 'Kangwon', 'North Pyongan', 'South Pyongan', 'Yanggang', 'Kaesong', 'Najin', 'Nampo', 'Pyongyang']
  },
  {
    country: 'Korea South',
  ...
  {
    country: 'Lesotho',
    state: ['Berea', 'Butha-Buthe', 'Leribe', 'Mafeteng', 'Maseru', 'Mohals Hoek', 'Mokhotlong', 'Qachas Nek', 'Quthing', 'Thaba-Tseka']
  },
  {
    country: 'Liberia',
  ...
  {
    country: 'New Zealand',
    state: ['Auckland', 'Bay of Plenty', 'Canterbury', 'Chatham Islands', 'Gisborne', 'Hawkes Bay', 'Manawatu-Wanganui', 'Marlborough', 'Nelson', 'Northland', 'Otago', 'Southland', 'Taranaki', 'Tasman', 'Waikato', 'Wellington', 'West Coast']
  },
  {
    country: 'Nicaragua',
  ...
  {
    country: 'Qatar',
    state: ['Ad Dawhah', 'Al Ghuwayriyah', 'Al Jumayliyah', 'Al Khawr', 'Al Wakrah', 'Ar Rayyan', 'Jarayan al Batinah', 'Madinat ash Shamal', 'Umm Said', 'Umm Salal']
  },
  {
    country: 'Romania',
  ...
  {
    country: 'Samoa',
    state: ['Aana', 'Aiga-i-le-Tai', 'Atua', 'Faasaleleaga', 'Gagaemauga', 'Gagaifomauga', 'Palauli', 'Satupaitea', 'Tuamasaga', 'Vaa-o-Fonoti', 'Vaisigano']
  },
  {
    country: 'San Marino',
  ...
  },
  {
    ...
    state: ['Al Bahah', 'Al Hudud ash Shamaliyah', 'Al Jawf', 'Al Madinah', 'Al Qasim', 'Ar Riyad', 'Ash Sharqiyah', 'Asir', 'Hail', 'Jizan', 'Makkah', 'Najran', 'Tabuk']
  },
  {
    country: 'Senegal',
  ...
  },
  {
    ...
    state: ['Kosovo', 'Montenegro', 'Serbia', 'Vojvodina']
  },
  {
    country: 'Seychelles',
  ...
  {
    country: 'Slovenia',
    state: ['Ajdovscina', 'Beltinci', 'Benedikt', 'Bistrica ob Sotli', 'Bled', 'Bloke', 'Bohinj', 'Borovnica', 'Bovec',
      'Braslovce', 'Brda', 'Brezice', 'Brezovica', 'Cankova', 'Celje', 'Cerklje na Gorenjskem', 'Cerknica', 'Cerkno',
      'Cerkvenjak', 'Crensovci', 'Crna na Koroskem', 'Crnomelj', 'Destrnik', 'Divaca', 'Dobje', 'Dobrepolje', 'Dobrna',
      'Dobrova-Horjul-Polhov Gradec', 'Dobrovnik-Dobronak', 'Dolenjske Toplice', 'Dol pri Ljubljani', 'Domzale', 'Dornava',
      'Dravograd', 'Duplek', 'Gorenja Vas-Poljane', 'Gorisnica', 'Gornja Radgona', 'Gornji Grad', 'Gornji Petrovci', 'Grad',
      'Grosuplje', 'Hajdina', 'Hoce-Slivnica', 'Hodos-Hodos', 'Horjul', 'Hrastnik', 'Hrpelje-Kozina', 'Idrija', 'Ig',
      'Ilirska Bistrica', 'Ivancna Gorica', 'Izola-Isola', 'Jesenice', 'Jezersko', 'Jursinci', 'Kamnik', 'Kanal',
      'Kidricevo', 'Kobarid', 'Kobilje', 'Kocevje', 'Komen', 'Komenda', 'Koper-Capodistria', 'Kostel', 'Kozje',
      'Kranj', 'Kranjska Gora', 'Krizevci', 'Krsko', 'Kungota', 'Kuzma', 'Lasko', 'Lenart', 'Lendava-Lendva', 'Litija',
      'Ljubljana', 'Ljubno', 'Ljutomer', 'Logatec', 'Loska Dolina', 'Loski Potok', 'Lovrenc na Pohorju', 'Luce',
      'Lukovica', 'Majsperk', 'Maribor', 'Markovci', 'Medvode', 'Menges', 'Metlika', 'Mezica', 'Miklavz na Dravskem Polju',
      'Miren-Kostanjevica', 'Mirna Pec', 'Mislinja', 'Moravce', 'Moravske Toplice', 'Mozirje', 'Murska Sobota', 'Muta',
      'Naklo', 'Nazarje', 'Nova Gorica', 'Novo Mesto', 'Odranci', 'Oplotnica', 'Ormoz', 'Osilnica', 'Pesnica',
      'Piran-Pirano', 'Pivka', 'Podcetrtek', 'Podlehnik', 'Podvelka', 'Polzela', 'Postojna', 'Prebold', 'Preddvor',
      'Prevalje', 'Ptuj', 'Puconci', 'Race-Fram', 'Radece', 'Radenci', 'Radlje ob Dravi', 'Radovljica', 'Ravne na Koroskem',
      'Razkrizje', 'Ribnica', 'Ribnica na Pohorju', 'Rogasovci', 'Rogaska Slatina', 'Rogatec', 'Ruse', 'Salovci',
      'Selnica ob Dravi', 'Semic', 'Sempeter-Vrtojba', 'Sencur', 'Sentilj', 'Sentjernej', 'Sentjur pri Celju',
      'Sevnica', 'Sezana', 'Skocjan', 'Skofja Loka', 'Skofljica', 'Slovenj Gradec', 'Slovenska Bistrica',
      'Slovenske Konjice', 'Smarje pri Jelsah', 'Smartno ob Paki', 'Smartno pri Litiji', 'Sodrazica', 'Solcava',
      'Sostanj', 'Starse', 'Store', 'Sveta Ana', 'Sveti Andraz v Slovenskih Goricah', 'Sveti Jurij', 'Tabor', 'Tisina',
      'Tolmin', 'Trbovlje', 'Trebnje', 'Trnovska Vas', 'Trzic', 'Trzin', 'Turnisce', 'Velenje', 'Velika Polana',
      'Velike Lasce', 'Verzej', 'Videm', 'Vipava', 'Vitanje', 'Vodice', 'Vojnik', 'Vransko', 'Vrhnika', 'Vuzenica',
      'Zagorje ob Savi', 'Zalec', 'Zavrc', 'Zelezniki', 'Zetale', 'Ziri', 'Zirovnica', 'Zuzemberk', 'Zrece']
  },
  {
  ...
  {
    country: 'Sri Lanka',
    state: ['Central', 'North Central', 'North Eastern', 'North Western', 'Sabaragamuwa', 'Southern', 'Uva', 'Western']
  },
  {
    country: 'Sudan',
    state: ['Aali an Nil', 'Al Bahr al Ahmar', 'Al Buhayrat', 'Al Jazirah', 'Al Khartum', 'Al Qadarif', 'Al Wahdah', 'An Nil al Abyad', 'An Nil al Azraq', 'Ash Shamaliyah', 'Bahr al Jabal', 'Gharb al Istiwaiyah', 'Gharb Bahr al Ghazal', 'Gharb Darfur', 'Gharb Kurdufan', 'Janub Darfur', 'Janub Kurdufan', 'Junqali', 'Kassala', 'Nahr an Nil', 'Shamal Bahr al Ghazal', 'Shamal Darfur', 'Shamal Kurdufan', 'Sharq al Istiwaiyah', 'Sinnar', 'Warab']
  },
  {
    country: 'Suriname',
  ...
  {
    country: 'Sweden',
    state: ['Blekinge', 'Dalarnas', 'Gavleborgs', 'Gotlands', 'Hallands', 'Jamtlands', 'Jonkopings', 'Kalmar', 'Kronobergs', 'Norrbottens', 'Orebro', 'Ostergotlands', 'Skane', 'Sodermanlands', 'Stockholms', 'Uppsala', 'Varmlands', 'Vasterbottens', 'Vasternorrlands', 'Vastmanlands', 'Vastra Gotalands']
  },
  {
    country: 'Switzerland',
  ...
  {
    country: 'Syria',
    state: ['Al Hasakah', 'Al Ladhiqiyah', 'Al Qunaytirah', 'Ar Raqqah', 'As Suwayda', 'Dara', 'Dayr az Zawr', 'Dimashq', 'Halab', 'Hamah', 'Hims', 'Idlib', 'Rif Dimashq', 'Tartus']
  },
  {
    country: 'Taiwan',
    state: ['Chang-hua', 'Chia-i', 'Hsin-chu', 'Hua-lien', 'I-lan', 'Kao-hsiung', 'Kin-men', 'Lien-chiang', 'Miao-li', 'Nan-tou', 'Peng-hu', 'Ping-tung', 'Tai-chung', 'Tai-nan', 'Tai-pei', 'Tai-tung', 'Tao-yuan', 'Yun-lin', 'Chia-i', 'Chi-lung', 'Hsin-chu', 'Tai-chung', 'Tai-nan', 'Kao-hsiung city', 'Tai-pei city']
  },
  {
    country: 'Tanzania',
  ...
  {
    country: 'Ukraine',
    state: ['Cherkasy', 'Chernihiv', 'Chernivtsi', 'Crimea', 'Dnipropetrovsk', 'Donetsk', 'Ivano-Frankivsk', 'Kharkiv', 'Kherson', 'Khmelnytskyy', 'Kirovohrad', 'Kiev', 'Kyyiv', 'Luhansk', 'Lviv', 'Mykolayiv', 'Odesa', 'Poltava', 'Rivne', 'Sevastopol', 'Sumy', 'Ternopil', 'Vinnytsya', 'Volyn', 'Zakarpattya', 'Zaporizhzhya', 'Zhytomyr']
  },
  {
    country: 'United Arab Emirates',
    state: ['Abu Dhabi', 'Ajman', 'Al Fujayrah', 'Sharjah', 'Dubai', 'Ras al Khaymah', 'Umm al Qaywayn']
  },
  {
  ...
  {
    country: 'Uzbekistan',
    state: ['Andijon Viloyati', 'Buxoro Viloyati', 'Fargona Viloyati', 'Jizzax Viloyati', 'Namangan Viloyati', 'Navoiy Viloyati', 'Qashqadaryo Viloyati', 'Qaraqalpogiston Respublikasi', 'Samarqand Viloyati', 'Sirdaryo Viloyati', 'Surxondaryo Viloyati', 'Toshkent Shahri', 'Toshkent Viloyati', 'Xorazm Viloyati']
  },
  {
    country: 'Vanuatu',
  ...
  {
    country: 'Yemen',
    state: ['Abyan', 'Adan', 'Ad Dali', 'Al Bayda', 'Al Hudaydah', 'Al Jawf', 'Al Mahrah', 'Al Mahwit', 'Amran', 'Dhamar', 'Hadramawt', 'Hajjah', 'Ibb', 'Lahij', 'Marib', 'Sadah', 'Sana', 'Shabwah', 'Taizz']
  },
  {
    country: 'Zambia',
